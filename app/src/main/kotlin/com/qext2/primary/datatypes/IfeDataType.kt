...
@Keep
class IfeDataType : DataTypeImpl("qext2", "qext2-ife") {
        ...
        scope.launch {
            ...
            ext.aggregatorFlow
                ...
                .collect { snap ->
                    ...
                    next.setTextViewText(R.id.tv_single_label, "IFe")
                    next.setTextViewText(R.id.tv_single_value, StatsValueFormatter.ifEff(snap.ifEffWholeRide).main)
